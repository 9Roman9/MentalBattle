...
public class Task {
    ...
    public void createExamples(){
        ...
        examples.put("Знайти значення числового виразу:\n15 4/14 + 11 5/7 : (4 1/2 * 2 2/9 - 3 1/6)",17);
        examples.put("Обчисліть:\n(3 1/6 + 5.2)/((4.6 - 5/12) * 0.4)",5);
        ...
        examples.put("Господарю потрібно зорати город, що має форму прямокутної трапеції. Розміри городу вказано на рисунку. Оранка трактором ділянки площею 100 м кв. коштує 8 грн. Скільки грошей (у грн.) повинен заплатити господар трактористу за оранку всього городу?",288);
